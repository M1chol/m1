...
> Edit 12.01.2026
> There was an update for SDK Manager Windows version, and now you can directyly flash the Jetson from windows device. Rest of the blog is still useful, but you don't need to download and create a virtual machine. Also the Nvidia's documentation on setting up the Jetson was "refreshed" and in my opinion for the worse. You still can see the original instructions in the [archive](https://www.jetson-ai-lab.com/archive/initial_setup_jon_sdkm.html)
